...
phpcs:
	/tmp/phpcs -p -s -v themes/kelpie --standard=WordPress-Extra --extensions=php --runtime-set ignore_warnings_on_exit true

phpcbf:
	/tmp/phpcbf -p -s -v themes/kelpie --standard=WordPress-Extra
